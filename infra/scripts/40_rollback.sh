...
"${SSH_BASE[@]}" "set -e; \
  ...
  \${DOCKER_CMD} exec wordpress_app sh -lc 'mkdir -p /var/www/html/wp-content/uploads /var/www/html/wp-content/plugins && chown -R www-data:www-data /var/www/html/wp-content/uploads /var/www/html/wp-content/plugins && chmod -R u+rwX,g+rwX /var/www/html/wp-content/uploads /var/www/html/wp-content/plugins'; \
